...
class DeliveryReport extends \DC\SMS\DeliveryReportBase {
    ...
    private $resultCodeLookup = [
        ...
        1    => [true,  false, false, "Temporary routing error", \DC\SMS\DeliveryState::ProviderError],
        2    => [true,  false, false, "Permanent routing error", \DC\SMS\DeliveryState::ProviderError],
        3    => [true,  false, false, "Maximum throttling exceeded", \DC\SMS\DeliveryState::Rejected],
        4    => [true,  false, false, "Timeout", \DC\SMS\DeliveryState::Undeliverable],
        5    => [true,  false, false, "Operator unknown error", \DC\SMS\DeliveryState::OperatorError],
        6    => [true,  false, false, "Operator error", \DC\SMS\DeliveryState::OperatorError],
        104  => [true,  false, false, "Configuration error", \DC\SMS\DeliveryState::Rejected],
        105  => [true,  false, false, "Internal error (internal Link Mobility error)", \DC\SMS\DeliveryState::ProviderError],
        ...
        1004 => [true,  false, false, "Mobile full", \DC\SMS\DeliveryState::Undeliverable],
